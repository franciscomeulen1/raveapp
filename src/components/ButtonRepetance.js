function Register() {
    return (
        <>
            <h1 class="text-3xl font-normal leading-normal mt-0 mb-2 bg-base-100">
                Botón de arrepentimiento - Reembolso

            </h1>
            <p class="text-xl font-light leading-relaxed mt-6 mb-4 bg-base-100">
                Contás con el derecho al reembolso de la orden comprada siempre y cuando no hayan transcurrido 10 dias corridos desde su compra. Una vez recibida la solicitud, ejecutaremos el reembolso a la cuenta de dónde salieron los fondo dentro de las sisguientes 24hs hábiles.
            </p>
            <hr />
