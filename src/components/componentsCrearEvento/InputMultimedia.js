    ...
    return (
        <div>
            ...
            <div className="form-control w-full mb-4">
                ...
                {previewUrl && (
                    <div className="mt-4">
                        <div className="w-full max-w-[400px] sm:max-w-[420px] md:max-w-[440px] h-48 md:h-56 overflow-hidden bg-black flex items-center justify-center rounded-lg shadow-md">
                            <img
                                src={previewUrl}
