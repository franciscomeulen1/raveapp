  ...
  const renderUserMenu = () => {
    ...
    if (isAdmin) {
      return (
        <>
          ...
          <li>
            <details>
              <summary>ABM Artistas</summary>
              <ul className="p-2 bg-white rounded-box">
                <li>
    ...
    if (isOrganizador) {
      items.push(
        ...
        <li key="o-reporte"><Link to="/reporte-mis-ventas">Reporte de ventas</Link></li>
      );
    }
