...
//       api.get(`http://144.22.158.49:8080/v1/noticia/${id}`)
//         .then(response => {
//           // Se asume que la respuesta retorna la noticia en response.data.noticia
//           setNoticiaData(response.data.noticia);
//           setLoading(false);
//         })
//         .catch(err => {
...
//             <p className="text-gray-700 leading-relaxed">{noticiaData.noticia}</p>
//           </div>
//         </div>
//       </div>
//       <Footer />
